...
export default function ReadingFilters({ filters, activities, onConfirm }: ReadingFiltersProps) {
  ...
  return (
    <ScrollView>
      ...
      <FilterItem label="Nascondi task eseguiti" count={activities.filter((a) => !!a.value && a.value !== "0").length}>
        <Button
          onPress={() => toggleFilter("reading-notExecuted")}
          IconComponent={Ionicons}
          iconProps={{ name: isChecked("reading-notExecuted") ? "checkbox" : "square-outline", color: "#789FD6", size: 24 }}
          theme="checkbutton"
        />
      </FilterItem>
